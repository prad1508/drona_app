...
class CoachActivateNumber extends StatefulWidget {
  const CoachActivateNumber({super.key, required this.index});

  final int index;

  @override
  State<CoachActivateNumber> createState() => _CoachActivateNumberState();
}

class _CoachActivateNumberState extends State<CoachActivateNumber> {
