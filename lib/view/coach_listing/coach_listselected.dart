...
class _CoachListSelectedState extends State<CoachListSelected> {
  ...
  @override
  void dispose() {
    // Use the reference to 'ancestor' saved in didChangeDependencies()
    // to safely refer to an ancestor widget during disposal.
    super.dispose();
  }
                      ...
                      return SingleChildScrollView(
                        child: SizedBox(
                          ...
                          child: ListView.builder(
                            itemCount: value.dataList1.data?.data.length,
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: [
                                                            Padding(
                                                                padding:
                                                                    const EdgeInsets
                                                                        ...
                                                                        left:
                                                                            15.0),
                                                                child: value.dataList1.data?.data[index].gender ==
                                                                            'm' ||
                                                                        value.dataList1.data?.data[index].gender ==
                                                                            'male'
                                                                    ? const Text(
                                                                        "Male",
                                                                        style:
                                                            ...
                                                            Text(
                                                              '${value.dataList1.data!.data[index].dob} Yrs | ${value.dataList1.data?.data[index].userid}',
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        height:
                                                                            24,
                                                                        decoration:
                                                                            const BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/Golf.png'), alignment: Alignment.centerRight)),
                                                                      ),
                                                                    ),
                                                                  ),
                                                                ),
