...
class CoachDeactivate_Page extends StatefulWidget {
  const CoachDeactivate_Page({super.key});

  @override
  State<CoachDeactivate_Page> createState() => _CoachDeactivate_PageState();
}

class _CoachDeactivate_PageState extends State<CoachDeactivate_Page> {
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child:
            ...
            Padding(
              padding:
                  const EdgeInsets.only(top: 12.0, left: 25.0, right: 26.0),
              child: SizedBox(
                child: Column(
                  children: [
                    Center(
