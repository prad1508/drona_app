            ...
            switch (value.dataList.status!) {
              ...
              case Status.completed:
                if(value.dataList.data != null){
                  doj.text = value.dataList.data!.data[widget.index].dateOfJoining.toString();
                  mob.text = value.dataList.data!.data[widget.index].monthOfBilling.toString();
                  fee.text = value.dataList.data!.data[widget.index].fees.toString();
                }
                          ...
                          children: [
                            ...
                            SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  readOnly: true,
                                  initialValue: value.dataList.data!
