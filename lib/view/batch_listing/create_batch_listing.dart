...
//                                     : Container(),
//                                 (value.dataList.data?.data![0].programs)?.isNotEmpty ?? false ? SizedBox(height: 50,
//                                   //color: Colors.amber,
...
//                                               valueName: value.dataList.data?.data![0].programs![index].programName.toString() ?? '',
//                                               groupValue: _programUid,
//                                               onChanged: _valueChangedHandler(_programUid),
//                                               onChangedName: _nameChangedHandler(_programName),
