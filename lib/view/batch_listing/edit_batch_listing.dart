        ...
        ChangeNotifierProvider<BatchListViewViewModel>(
            ...
            child: Consumer<BatchListViewViewModel>(
                builder: (context, value, _) {
                  // _groupBatch = value.dataList.data?.data![widget.Listindex].
                  return
                    Scaffold(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ChangeNotifierProvider<CoachlistViewViewModel>(
                                      ...
                                      child: Consumer<CoachlistViewViewModel>(
                                          builder: (context, value, child) {
                                            print(
                                                "object==${value.dataList.data!.coachlist
                                                    .length}");

                                            profileUid =
                                                value.dataList.data!.coachlist[0].uid
                                                    .toString() ??
                                                    '';
                                ...
                                ChangeNotifierProvider<MyProgramViewViewModel>(
                                  ...
                                  child: Consumer<MyProgramViewViewModel>(
                                      builder: (context, value, _) {
                                        ...
                                        _programName = value
                                            .dataList.data?.data![0].programs![0]
                                            .programName
                                            .toString();
                                        return Column(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                ...
                                ChangeNotifierProvider<MyProgramViewViewModel>(
                                    create: (
                                        BuildContext context) => myProgramViewViewModel,
                                    child: Consumer<MyProgramViewViewModel>(
                                        builder: (context, value, _) {
                                          for (var fee
                                          ...
                                          return TextFormField(
                                            readOnly: true,
                                            controller: fee
                                              ..text = value.dataList.data?.data![0]
                                                  .programs![0].amount ??
                                                  '0',
                                            decoration: InputDecoration(
                                              contentPadding: const EdgeInsets.all(10),
