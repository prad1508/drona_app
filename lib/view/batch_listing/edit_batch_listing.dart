...
class _EditBatchListingState extends State<EditBatchListing > {
  ...
  Widget build(BuildContext context) {
            ...
            create: (BuildContext context) => batchListViewViewModel,
                ...
                builder: (context, value, _) {
                  ...
                  //       .toString() ?? batchTodata.toString(),
                          ...
                          selectedService = value.dataList.data?.data![widget.Listindex].serviceName;
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (BuildContext context) =>
               CreateProfile(listindex : widget.Listindex),
            ),
          );
        },
      ),
    ...
    hintText: value.dataList.data
        ?.data![widget.Listindex].batchTimingFrom.toString(),
    contentPadding: const EdgeInsets.all(10),
    border: OutlineInputBorder(
    borderRadius: BorderRadius.circular(5.0),
    borderSide: BorderSide(
    ...
    onPress: () {
      ...
      'batch_uid':value.dataList.data!.data?[widget.Listindex].uid.toString(),
      'batch_name':batchName.text.toString(),
       'coach_profile_uid':profileUid.toString(),
      'program_uid':value.dataList.data!.data?[widget.Listindex].programUid.toString(),
      'program_name':value.dataList.data!.data?[widget.Listindex].programName.toString(),
      'fees':value.dataList.data!.data?[widget.Listindex].fees,
      /// because currently getting null
      'type_batch':'group',
      'provide_online_sessions':onlineSession.toString(),
