                        ...
                        switch (value.dataList.status!) {
                          ...
                          case Status.completed:
                            ...
                            for(var index = 0 ; index<num! ;index++)
                            {
                              ...
                              programName.add(value.dataList.data!.data![0].programs![index].programName);
                                    ...
                                    Container(
                                      ...
                                      child:  ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            if(int.parse(value.dataList.data!.data![0].programs![index].amount.toString())!= 0)
                                            {
                                            ...
                                            return
                                              Column(
                                                children: [
                                                  ...
                                                  int.parse(value.dataList.data!.data![0].programs![index].amount.toString()) != 0 ?
                                                  Container(
