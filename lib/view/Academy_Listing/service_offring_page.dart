...
class Service_Offering_Page extends StatefulWidget {
     ...
     String serviceUid;
   Service_Offering_Page({super.key, required this.serviceUid});
...
class _Service_Offering_PageState extends State<Service_Offering_Page> {
  ...
  getData()
  async {
    serviceViewViewModel.fetchServiceListApi(widget.serviceUid);
  }
                      ...
                      onPress: () async {
                        if (serviceList.isEmpty) {
                          ...
                          Map<String, dynamic> data = {
                            "cat_uid": catUid,
                            "service_uid": serviceList[0]["service_uid"],
                          };

                          registration.servicePostFromDashBoard(data, context, serviceUid: serviceList[0]["service_uid"], serviceName:serviceList[0]["service_name"] );
                        }
                      }),
                ],
              ),
