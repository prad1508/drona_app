...
class ViewDetailClosed extends StatefulWidget {
  ...
  ViewDetailClosed({super.key, required this.id, required this.serviceIcon, required this.attendanceList});
                        ...
                        children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                        ...
                                        children: [
                                          Chip(
                                              backgroundColor: Colors.redAccent
                                                  .withOpacity(.2),
                                              label:  Text(
                                                value.dataList2.data!.status.toString(),
                                                style: TextStyle(
                                    ...
                                    Column(
                                      ...
                                      children:  [
                                        Text(
                                          value.dataList2.data!.batchName.toString(),
                                          style: TextStyle(
                                              color: Colors.black,
                                        ...
                                        Padding(
                                          ...
                                          child: Chip(
                                            ...
                                            avatar: CircleAvatar(
                                              ...
                                              child: Text(widget.attendanceList.length
                                                  .toString()),
                                            ),
                                          ),
                                        ),
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: ListView.builder(
                                                      ...
                                                      itemBuilder:
                                                        ...
                                                        return
                                                          widget.attendanceList[index].attendance == "P" ?
                                                          Card(
                                                              ...
                                                              ListTile(
                                                                ...
                                                                leading:
                                                                    CircleAvatar(
                                                                        ...
                                                                        child: _selectedItems.contains(index)
                                                                            ...
                                                                            : Text(
                                                                                (widget.attendanceList[index].traineeName[0][0].toString() + widget.attendanceList[index].traineeName[1][0].toString()).toUpperCase(),
                                                                                style: const TextStyle(fontSize: 14),
                                                                              )),
                                                                title: Text(
                                                                  widget.attendanceList[index].traineeName,
                                                                ...
                                                                subtitle: Row(
                                                                  children: [
                                                                    ...
                                                                    Text(" - "),
                                                                    Text(
                                                                      widget.attendanceList[index].dob,
                                                                      // value.dataList2.data!.data[index].id,
                                                                      style: const TextStyle(
                                                                          color: Color.fromRGBO(
                                                                              57, 64, 74, 1),
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children:  [
                                                                      CircleAvatar(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            widget.attendanceList[index].attendance.toString(),
                                                                            style:
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: ListView.builder(
                                                      ...
                                                      itemBuilder:
                                                        ...
                                                        return
                                                          widget.attendanceList[index].attendance == "A" ?
                                                          Card(
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: ListView.builder(
                                                      ...
                                                      itemBuilder:
                                                        ...
                                                        return
                                                          widget.attendanceList[index].attendance == "L" ?
                                                          Card(
                          ...
                          RoundButton(
                              ...
                              onPress: () {
                                ...
                                Map<String, dynamic> data = {"session_uid":widget.id,
                                  "feedback_trainee":feedbackTraineeController.text,
                                  "feedback_academy":feedbackAcademyController.text,
                                  "attachfile":[]
                                };
                                print("data==$data");
