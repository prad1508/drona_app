...
class SplashServices with ChangeNotifier {
  ...
  void checkAuthentication(BuildContext context) async {
    ...
    try {
      ...
      print(value);
      setLoading(false);
      setupProgress = value['onboarding_completed'] != null
          ? value['onboarding_completed']
          : 0;
      print("setupprogress is $setupProgress");

      setupFinish = value['onboarding_setup_finish'] != null
          ? value['onboarding_setup_finish']
          : false;
